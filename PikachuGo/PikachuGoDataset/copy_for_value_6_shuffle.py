...
"""
dataset_dir                                                 = 'E:/PikachuGoDataSample/5_value_drop/dataset/'
"""
经过第4步或第5步操作后，数据集标签的位置
"""
label_dir                                                   = "E:/PikachuGoDataSample/5_value_drop/label/"

"""
输出的目标目录（数据集）
"""
output_data_dir                                             = 'E:/PikachuGoDataSample/7_value_shuffle/dataset/'
"""
输出的目标目录（标签集）
"""
output_label_dir                                            = 'E:/PikachuGoDataSample/7_value_shuffle/label/'
